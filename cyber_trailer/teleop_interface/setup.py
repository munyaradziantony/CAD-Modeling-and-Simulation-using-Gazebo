...
setup(
    ...
    long_description="""\
        teleop_interface provides command-line interface to send Twist commands \
        to drive a robot around.""",
    license='BSD',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'teleop_keyboard = teleop_interface.teleop_keyboard:main',
            'teleop_joystick_traditional = teleop_interface.teleop_joystick_traditional:main',
            'teleop_joystick_alternate = teleop_interface.teleop_joystick_alternate:main'
        ],
    },
)
